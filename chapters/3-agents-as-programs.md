...
>**Exercise**: Monty Hall. In this exercise inspired by [ProbMods](http://probmods.org/chapters/social-cognition.html), we will approach the classical statistical puzzle from the perspective of optimal decision-making. Here is a statement of the problem:
