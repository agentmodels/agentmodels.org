...
Unfortunately, finding the optimal policy for POMDPs is a difficult task. In fact, even in the special case where the observations are deterministic, the task of determining whether the optimal policy has expected utility greater than some constant is PSPACE-complete refp:papadimitriou1987complexity.
